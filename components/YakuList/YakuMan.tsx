  ...
  return (
    ...
    <Box bg="blue.100" marginBottom="1.5%">
      ...
      <Box display="flex" fontSize="18px">
        <Text bg="blue.300" border="solid" margin="0 1%">1翻</Text>
        <Text bg="blue.300" border="solid" marginRight="1%">鳴きNG</Text>
      </Box>
      </Box>
      ...
      <Text fontSize="20px" margin="1% 1%">同じ種類の数牌で同じ順子を2面子揃えると成立する役。七対子とは複合しない。</Text>   
  </Box></>
  )
}
